#!/bin/bash
# this recovers missing 10.10.1.X IPs on Mellanox interfaces by restoring the CloudLab VLAN
...
# find vlan line, typically looks like: vlan306 10.10.1.1 02fcbf43aeb2
...
# get VLAN ID from the name (e.g. vlan306 --> 306)
